...
label best_end:
    ...
    if mc_crush == True:
        ...
        at ehappy_c mhappy_o twag bhappy "And how many can say they're friends with a dragon knight?"
    ...
    at ehappy_c mhappy_o tneutral bneutral "Ah.. That sounds nice-"
    ...
    if mc_crush == True:
        ...
        at esad_la msad_c bsad tloop "I... But... Are you sure you want me to accompany you?"
        ...
        $ blush_heavy = True
        at esad "F-forgive my forwardness, but... Are.. Are you f-flirting with me...?"
        ...
        at ehappy_c mhappy_c twag "I... I would positively love that."
        "He smiles at me shyly before leaning in to peck me on my cheek."
        at ehappy mhappy_o "U-um, I shall go pack my belongings right away!" 
        ...
        at ehappy mhappy_o bhappy "No, I want to go!"
        at esad_la msad_c bsad tloop "I... But... Are you sure you want me to accompany you?"
        ...
        at ehappy_c mhappy_c twag "...Yes."
        at mhappy_o "Yes., I would positively love that!"
